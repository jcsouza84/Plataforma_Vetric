...
/**
 * 🚀 EXECUTAR MIGRATIONS - SUPER SIMPLES
 * 
 * Apenas execute: node executar-migrations-simples.js
 */
...
console.log('\n🗃️  EXECUTAR MIGRATIONS - Sistema VETRIC\n');
console.log('='.repeat(60));
console.log('\n📌 Vou executar as migrations automaticamente!\n');
console.log('🔐 Preciso da DATABASE_URL do Render.\n');
console.log('📍 Onde encontrar:');
console.log('   1. Abra: https://dashboard.render.com');
console.log('   2. Clique em "vetric-db"');
console.log('   3. Copie a "Internal Database URL"\n');
console.log('='.repeat(60));
console.log('\n');

rl.question('Cole a DATABASE_URL aqui: ', async (DATABASE_URL) => {
  rl.close();
